...
return [
    ...
    */
    ...
    'backend' => [
        ...
        'welcome' => '<p>تم gq1994 توسط <a href="https://coreui.io/" target="_blank">creativeLabs</a> ایجاد شده است. این یک نسخه دسته پایین با تنها سبک و اسکریپت‌های لازم برای اجرای آن است. نسخه کامل را برای شروع افزودن اجزای به داشبورد خود دانلود کنید.
</p>
