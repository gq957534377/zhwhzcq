...
return [
    ...
    */
    ...
    'backend'  => [
        ...
        'welcome'   => '
<p>В этом проекте использована тема оформления <strong>gq1994</strong> с минимальным набором стилей и сценариев, необходимых для его работы.</p>
<p>Используйте полную версию <strong>gq1994</strong> шаблона по адресу <a href="https://coreui.io/" target="_blank">creativeLabs</a> и добавляйте в это приложение необходимые вам компоненты.</p>
