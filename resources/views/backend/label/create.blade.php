...
@section ('title', __('labels.backend.access.labels.management') . ' | ' . __('labels.backend.access.labels.create'))
...
@section('content')
    {{ html()->form('POST', route('admin.labels.store'))->class('form-horizontal')->open() }}
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-5">
                        <h4 class="card-title mb-0">
                            ...
                            <small class="text-muted">{{ __('labels.backend.access.labels.create') }}</small>
                        </h4>
                    </div><!--col-->
                </div><!--row-->
